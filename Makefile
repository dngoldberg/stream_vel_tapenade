...
$(EXEC):  driver.f90 adStack.o stream_vel_dan_b.o conj_grad.o stream_vel_dan.o adFixedPoint.o conj_grad_adj.o
	$(F90) -o $(EXEC) driver.f90 adStack.o stream_vel_dan_b.o conj_grad.o stream_vel_dan.o adFixedPoint.o conj_grad_adj.o
...
adFixedPoint.o : adFixedPoint.c adFixedPoint.h
	$(CC) -c adFixedPoint.c
...
conj_grad.o: conj_grad.f90 stream_vel_variables.mod
	$(F90) -c conj_grad.f90
#conj_grad_b.o: conj_grad_b.f90 stream_vel_variables.mod
#	$(F90) -c conj_grad_b.f90

driver.o: stream_vel_dan_b.f90 stream_vel_variables.mod 

adStack.o : adStack.c adStack.h
	$(CC) -c adStack.c
